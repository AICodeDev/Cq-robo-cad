...
axle_sq_rod=axle_sq_rod.translate((80,0,0))

show_object(axle_sq_rod)
...
bush_hole_base = (
    bush_hole_base.faces(">Z")
    .workplane()
    .pushPoints([(0, -4), (0, 4)])  # Offset from center: X +/- 1, Z +6 (near top)
    .hole(3.96)                      # Drill 1.0 diameter holes
)
bush_hole_base=bush_hole_base.translate((-5,0,0))
show_object(bush_hole_base)
...
bush_holder = (
    bush_holder.faces(">X")
    .workplane()
    .pushPoints([(0, 50)])  # Offset from center: X +/- 1, Z +6 (near top)
    .hole(12)                      # Drill 1.0 diameter holes
)
show_object(bush_holder)
bush_holder = bush_holder.union(bush_hole_base)
