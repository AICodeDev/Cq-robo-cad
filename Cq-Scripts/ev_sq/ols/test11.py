...
wheel_radius = 20 - reduce_wheel_rad   # Radius of the wheel (mm)
wheel_width = 16 - reduce_wheel_width     # Width/height of the wheel (mm)
...
wheel2 = (
    cq.Workplane("XY")
    .circle(wheel_radius)
    .extrude(wheel_width/2)
)
show_object(wheel2, options={"color": "blue", "alpha": 0.7})
...
show_object(d_shape2)

test = wheel2.cut(d_shape2)

show_object(test, options={"color": "orange", "alpha": 0.7})
