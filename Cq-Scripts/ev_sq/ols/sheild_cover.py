...
outer_box_length = 104-0.5      # = 142
outer_box_length_hole = 96-0.5      # = 142

outer_box_width = 72
outer_box_width_hole = 64

outer_box_thickness = 38
#76,64
#108,96
outer_box = (
    cq.Workplane("XY")
...
outer_box_length_cut1 = outer_box_length_hole - 8    # = 62
outer_box_width_cut1  = outer_box_width               # = 69
outer_box_thickness_cut1 = outer_box_thickness - 1            # = 20
...
outer_box_length_cut2 = outer_box_length +2   # = 62
outer_box_width_cut2  = outer_box_width_hole -8          # = 69
