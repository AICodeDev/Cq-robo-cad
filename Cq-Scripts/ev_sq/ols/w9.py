...
reduce_wheel_rad = 0
reduce_wheel_width = 0
reduce_hug_rad = 0
reduce_hug_wall =0

reduce_shaft_height =0 


wheel_radius = 30 - reduce_wheel_rad   # Radius of the wheel (mm)
wheel_width = 24 - reduce_wheel_width     # Width/height of the wheel (mm)
hub_wall=3-reduce_hug_wall
common_height= 4
shaft_height = 16 - reduce_shaft_height 
shaft_dia = 6.5 - 0.3
hole_dia = shaft_dia - 0.8
...
# to pass the screw
hole_height= total_height - shaft_height+1
hole_radius = shaft_dia/2 - 1
...
o_cut_height = 5  # Half the height of D-shape

# Create circular O-shape cut
o_shape = (
    cq.Workplane("XY")
    .workplane()
    .circle(o_cut_radius-0.5)
...
# -------- Spoke Parameters --------
spoke_count = 12
spoke_angle = 360/spoke_count -3          # reduced angle to avoid overlap
rim_thickness = 3      # outer rim wall thickness (mm)
