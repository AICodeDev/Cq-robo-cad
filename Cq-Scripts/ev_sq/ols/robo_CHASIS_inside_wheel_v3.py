...
gplateCut = (
    ...
    .rect(30, 96-22 )
    .extrude(2.5) )
gyro_plate = gyro_plate.cut(gplateCut)


gyro_plate = gyro_plate.translate((15,0,0))
show_object(gyro_plate)

castor_board_sonic_gyro=castor_board.union(sonic_con_plate_hole_x_triple).union(gyro_plate)
...
robo_CHASIS=(motor_plate_all).union(board2cut).union(castor_board_sonic_gyro)
