...
def create_motor_plate(length=24, width=16, thickness=4, hole_diameter=3.2, 
    ...
    """
    Simple motor mounting plate with holes using rarray.
    ...
    x_count : int - number of holes in horizontal direction
    y_count : int - number of holes in vertical direction
    """
    # Create rect plate on YZ plane (vertical)
    plate = (
        cq.Workplane("YZ")
