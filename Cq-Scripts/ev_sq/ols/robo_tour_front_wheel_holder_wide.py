...
show_object(main_rod_c1)



rv_front_holder= ( main_rod_c1
            .faces(">Z")
            .workplane()
            .pushPoints([ 
            # (0 ,4),
...
castor_holder_robo_tour = rv_front_holder.mirror(mirrorPlane="XY")
show_object(castor_holder_robo_tour)
