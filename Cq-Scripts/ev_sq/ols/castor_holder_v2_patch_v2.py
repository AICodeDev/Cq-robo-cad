...
show_object(plate_old)

castor_holder_patch= castor_holder2.cut(plate_old)
show_object(castor_holder_patch)
...
castor_holder_patch_v2 = castor_holder_patch.cut(plateY2)



show_object(castor_holder_patch_v2)
