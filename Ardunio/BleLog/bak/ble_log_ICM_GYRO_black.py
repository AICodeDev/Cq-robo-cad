...
#C4:F6:76:15:35:73
    ...
    #Found: ROBOBLOQ-k1 @ D9:C6:D8:9E:8B:56
  #Found: MyQ-ACA @ 0C:95:05:0F:FB:20
  #Found: MyQ-785 @ CA:6A:10:29:3F:11
...
async def continuous_monitoring():
    ...
    def log_data(data):
        loggable_string_ignore = data.decode('ascii', errors='ignore')
        print(f"Ignore errors: {loggable_string_ignore}")
        ...
        with open(log_file, 'a') as f:
            ...
            f.write(loggable_string_ignore);
    
    MAC_ADDRESS = "FE:F5:B8:73:09:64"  # <-- CHANGE THIS
    
    MAC_ADDRESS = "D9:C6:D8:9E:8B:56"  # <-- CHANGE THIS
    #DF:9B:A1:06:8B:1A
    MAC_ADDRESS = "DF:9B:A1:06:8B:1A"  # <-- CHANGE THIS
