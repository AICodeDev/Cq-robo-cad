...
// float how_much_it_is_going =3401;//3401
 
// float caliber_factor = how_much_it_should_go/how_much_it_is_going;
// //1.8 * 32/24

// float PULSES_PER_MM = (2.4* caliber_factor)  ;
...
//         press_count++;
//         if press_count%full = 1 {

//         }
//         if press_count%half = 1 : {
...
void goStraight(float mm) {
  ...
  long target = mm * PULSES_PER_MM_EV;
  Serial.print(" MM: ");
  Serial.print(mm);
  Serial.print(" Target: ");
  Serial.print(target);
  ...
  Serial.print((encoder_count - start));
  Serial.print(" Target: ");
