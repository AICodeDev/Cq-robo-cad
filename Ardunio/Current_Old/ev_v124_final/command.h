...
void excutePress(int press, int dir){
...
void executeCommand(char cmd) {
  switch (cmd) {
    ...
    case '-':  curr.global_direction = -1;  break;   
//    case 'M':  curr.mode = 'E' ;  break;   
    
    
    case '1':  excutePress( 1* 1 , curr.global_direction);  break;
    case '2':  excutePress( 1* 2 , curr.global_direction);  break;
    case '3':  excutePress( 1* 3 , curr.global_direction);  break;
    case '4':  excutePress( 1* 4 , curr.global_direction);  break;
    case '5':  excutePress( 1* 5 , curr.global_direction);  break;
    case '6':  excutePress( 1* 6 , curr.global_direction);  break;
    case '7':  excutePress( 1* 7 , curr.global_direction);  break;
    case '8':  excutePress( 1* 8 , curr.global_direction);  break;
    case '9':  excutePress( 1* 9 , curr.global_direction);  break;
    case '0':  excutePress( 1* 10 , curr.global_direction);  break;
